...
const PlaygroundPage = () => {
  ...
  const onSubmit = async () => {
    try {
      ...
      const response = await axios.post("/api/lyrics", { text: fileContent });
              ...
              <div className="flex flex-col space-y-4 ">
                ...
                <TabsContent value="complete" className="mt-0 border-0 p-0 space-y-2">
                  ...
                  <div className="flex h-full flex-col space-y-4">
                    ...
                    <Button className="rounded-md bg-slate-100 hover:rounded-md hover:bg-[#111827] text-[#111827] hover:text-green-500" onClick={handleNext}>Next</Button></div>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="insert" className="mt-0 border-0 p-0 space-y-2">
                  <div className="h-full p-2">
                    ...
                    <div className="flex-row">
                      <div className="w-full grid grid-cols-2 space-x-3 pt-4 pb-4">
                      ...
                      <div className="flex flex-row justify-end space-x-2">
                        ...
                        <div className="flex items-center justify-end space-x-2 ">
                        <Button className={cn("rounded-md border-2 bg-green-500 text-white hover:bg-gradient-to-r from-purple-400 to-pink-600 hover:rounded-md hover:text-green-500", font.className)} onClick={handleSubmit}>Submit</Button>                        </div>
                      </div>
